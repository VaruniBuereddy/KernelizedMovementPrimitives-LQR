...
# === FILE PATHS ===
nominal_path = "/home/iisc-hiro-lab-phd-2/Documents/data/c_1.csv"
stt_learned_path = "/home/iisc-hiro-lab-phd-2/Documents/KMP/C_results/c_STT_arm_LfD_tst.csv"
kmp_lqr_path = "/home/iisc-hiro-lab-phd-2/Documents/KMP/C_results/lqr_franka_output.csv"
dmp_umpc_path = "/home/iisc-hiro-lab-phd-2/Documents/DMP_LfD/C_results/lqr_franka_output.csv"


# === READ DATA ===
# Nominal: no header, last three columns are x, y, z
nominal = pd.read_csv(nominal_path, header=0)
nominal_xyz = nominal[['x', 'y', 'z']].to_numpy()
...
# KMP+LQR: has header
kmp = pd.read_csv(kmp_lqr_path, header=0)
kmp_xyz = kmp[['x', 'y', 'z']].to_numpy()
print("KMP shape:", kmp_xyz.shape)
print("First few rows:\n", kmp.head())

# DMP+UMPC: has header
dmp = pd.read_csv(dmp_umpc_path, header=0)
