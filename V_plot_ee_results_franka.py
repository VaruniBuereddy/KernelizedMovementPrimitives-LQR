...
# === FILE PATHS ===
nominal_path = "/home/iisc-hiro-lab-phd-2/Documents/data/v_1.csv"
stt_learned_path = "/home/iisc-hiro-lab-phd-2/Documents/KMP/V_results/v_STT_arm_LfD_tst.csv"
kmp_lqr_path = "/home/iisc-hiro-lab-phd-2/Documents/KMP/V_results/lqr_franka_output.csv"
dmp_umpc_path = "/home/iisc-hiro-lab-phd-2/Documents/DMP_LfD/V_results/lqr_franka_output.csv"
...
stt = pd.read_csv(stt_learned_path, header=0)
print(stt.head())
stt_xyz = stt[['x', 'y', 'z']].to_numpy()
