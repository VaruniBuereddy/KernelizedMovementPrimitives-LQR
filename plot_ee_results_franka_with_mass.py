...
kmp_lqr_path = "/home/iisc-hiro-lab-phd-2/Documents/KMP/results/lqr_franka_with_mass.csv"
dmp_umpc_path = "/home/iisc-hiro-lab-phd-2/Documents/DMP_LfD/results/umpc_franka_with_mass.csv"
...
ax.set_ylabel('Y (m)')
ax.set_zlabel('Z (m)')
ax.set_title('End Effector Trajectories under Perturbation with Added Mass')
ax.legend()
ax.grid(True)
